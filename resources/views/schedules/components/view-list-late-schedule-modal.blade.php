<!-- Modal Whatsapp -->
<div class="modal fade" id="modalSchedulingAtrasados" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" style="text-align: center; width: 100%;">Tarefa em atraso<span class="status"></span></h4>
            </div>
            <div class="modal-body">
                @foreach($atrasados as $scheduling)
                    <div class="tarefa">
...
<style>
    #modalSchedulingAtrasados .tarefa p{
        padding: 5px;
        margin-bottom: 0px;
    }
</style>
